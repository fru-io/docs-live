...
description:
freshdesk:
  title: Is certificate management included with the plans? # title	string	Title of the solution article
  id: 36000070260 # id	number	Unique ID of the solution article
